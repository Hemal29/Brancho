...
export const metadata: Metadata = {
  ...
  description:
    "Contact Brancho — India's trusted home services platform. Reach our Ahmedabad corporate office, customer support, or explore partnerships. We respond within hours.",
